          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="card product-item">
                    <img src="../img/products/dumpling.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
              ...
              <div class="col-md-4">
                  <div class="card product-item">
                    <img src="../img/products/noodle.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
              ...
              <div class="col-md-4">
                  <div class="card product-item">
                    <img src="../img/products/shrimpe.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
